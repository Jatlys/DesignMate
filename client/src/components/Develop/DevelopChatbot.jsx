      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm relative">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="bg-red-100 border-l-4 border-red-500 p-3 rounded-lg self-start max-w-xs">
            <p className="font-bold text-sm">Current Phase: Develop</p>
            <p className="text-sm">Focus on developing a diverse range of ideas and potential solutions.</p>
          </div>
          <div className="bg-yellow-100 p-3 rounded-lg self-start max-w-xs">
            <p className="text-sm"><span className="font-bold">Pro Tip:</span> Encourage wild ideas and defer judgment to foster a creative environment.</p>
          </div>
        </div>
