      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm relative">
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="bg-red-100 border-l-4 border-red-500 p-3 rounded-lg self-start max-w-xs">
            <p className="font-bold text-sm">Current Phase: Deliver</p>
            <p className="text-sm">Iteratively prototype and test concepts and models with users.</p>
          </div>
          <div className="bg-yellow-100 p-3 rounded-lg self-start max-w-xs">
            <p className="text-sm"><span className="font-bold">Pro Tip:</span> Use prototypes and storyboards to clearly communicate your ideas and gather feedback.</p>
          </div>
        </div>
