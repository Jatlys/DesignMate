      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm relative">
        ...
        <div className="space-y-3 mb-4">
          <div className="bg-gray-100 p-3 rounded-lg self-start max-w-xs">
            <p className="text-sm">Hi! I'm here to guide your team through the design innovation process. What would you like to do today?</p>
          </div>
          <div className="bg-yellow-100 p-3 rounded-lg self-start max-w-xs">
            <p className="text-sm"><span className="font-bold">Pro Tip:</span> You can start by creating a new project or viewing existing ones.</p>
          </div>
        </div>
